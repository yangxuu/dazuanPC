      ...
      <div class="main">
        <div class="location">
          <p>
            ...
            <router-link to="/newcate">产品中心</router-link>
          </p>
        </div>
        <div class="product_list">
          <div class="p_left">
            <h3>产品分类</h3>
            <ul>
              <li @click="allgoods" class="oneMenu"><span>全部商品</span></li>
              <li v-for="(one,index) in cate.cate.cate" :key="index" class="oneMenu">
                ...
                <ul v-if="one.flag">
                  <li v-for="(two,index) in one.children" :key="index" class="twoMenu">
                    <router-link :to="{path:'/newcate',query:{new_cate_id:two.id}}">{{two.name}}</router-link>
                  </li>
                </ul>
              </li>
            </ul>
